import { INSERT_ITEM, REMOVE_ITEM, REMOVE_ITEM_BY_KEY, RESET_LIST, UPDATE_ITEM, UPDATE_ITEM_BY_KEY } from "./list.reducer"
...
export const resetListAction = ({ reducerName }) => ({ type: RESET_LIST, meta: { reducerName } })
